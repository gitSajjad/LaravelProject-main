  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('post.update', $post->id) }}" method="POST" enctype="multipart/form-data" id="form">
                    @csrf
                    {{ method_field('put') }}
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control form-control-sm" id="status">
                                    <option value="0" @if (old('status', $post->status) == 0) @endif >غیرفعال</option>
                                    <option value="1" @if (old('status', $post->status) == 1) @endif >فعال</option>
                                </select>
                            </div>
                            @error('status')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control form-control-sm"  name="tags" value="{{ old('tags',$post->tags) }}" id="tags" >
