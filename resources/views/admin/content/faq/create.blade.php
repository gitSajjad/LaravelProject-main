  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('faq.store') }}" id="form" method="post">
                    @csrf
                    <section class="row">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="question" id="question" value="{{ old('question') }}"  class="form-control form-control-sm">
                            </div>
                            @error('question')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control form-control-sm"  name="tags" value="{{ old('tags') }}"  id="tags" >
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control form-control-sm" id="status">
                                    <option value="0" @if(old('status') == 0) @endif >فعال</option>
                                    <option value="1"@if(old('status') == 1) @endif  >غیر فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="alert_required bg-danger text-white p-2 mt-3 rounded" role="alert">
