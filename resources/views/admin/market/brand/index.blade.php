                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <td class="width-16-rem text-left">
                                <a href="{{ route('brand.changeStatus',$brand->id) }}" class="btn btn-warning btn-sm">وضعیت</a>
                                <a href="{{ route('brand.edit', $brand->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
