    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('product.create') }}" class="btn btn-info btn-sm">ایجاد کالای جدید </a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <form class="d-inline" action="{{ route('product.destroy',$product->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button  class="dropdown-item text-right delete" type="submit" ><i class="fa fa-window-close"></i> حذف</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
