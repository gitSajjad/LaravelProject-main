    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('property.value.create', $property->id) }}" class="btn btn-info btn-sm">ایجاد مقدار فرم کالا جدید</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $property->name }}</td>
                            <td> </td>
                           //////// نام محصول اینجااااا ارور داره
                            <td>{{ json_decode($value->value)->value }}</td>
                            <td>{{ json_decode($value->value)->price_increase }}</td>
                            <td>{{ $value->type == 0 ? 'ساده' : 'انتخابی'}}</td>
                            <td class="width-22-rem text-left">
                                <a href="{{ route('property.value.edit',['property' => $property->id , 'value' => $value->id] ) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
